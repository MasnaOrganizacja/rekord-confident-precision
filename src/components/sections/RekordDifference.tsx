    ...
    <section ref={sectionRef} className="py-32 bg-white">
      <div className="container mx-auto px-8">
        <h2 className="text-5xl lg:text-7xl font-bold text-gray-900 mb-4 text-center">
          Dlaczego <span className="text-luxury-forest-green">Rekord SI</span>?
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          ...
          <div className="bento-box lg:col-span-2 lg:row-span-2 bg-luxury-forest-green border-4 border-luxury-forest-green p-12 group hover:border-luxury-forest-green/80 transition-all duration-300 shadow-lg">
            <Award className="w-16 h-16 text-white mb-6 group-hover:scale-110 transition-transform duration-300" />
          ...
          <div className="bento-box bg-white border-4 border-luxury-forest-green p-8 group hover:border-luxury-forest-green/80 transition-all duration-300 shadow-lg">
            <MapPin className="w-12 h-12 text-luxury-forest-green mb-4 group-hover:scale-110 transition-transform duration-300" />
          ...
          {/* Small box 2 */}
          <div className="bento-box bg-white border-4 border-luxury-forest-green p-8 group hover:border-luxury-forest-green/80 transition-all duration-300 shadow-lg">
            <Headphones className="w-12 h-12 text-luxury-forest-green mb-4 group-hover:scale-110 transition-transform duration-300" />
            <h3 className="text-2xl font-bold text-gray-900 mb-4">
              Wsparcie Ekspertów
            </h3>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="bento-box lg:col-span-1 bg-gray-100 border-4 border-luxury-forest-green p-8 group hover:scale-105 transition-all duration-300 shadow-lg">
            <Zap className="w-12 h-12 text-luxury-forest-green mb-4 group-hover:scale-110 transition-transform duration-300" />
            <h3 className="text-2xl font-bold text-gray-900 mb-4">
              Ciągła Innowacja
            </h3>
