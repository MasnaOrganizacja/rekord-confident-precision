...
import { ArrowRight, Clock, User, Calendar, ExternalLink } from "lucide-react";
...
export const BlogPreview = () => {
  ...
  const featuredArticle = {
    ...
    excerpt: "Analiza kluczowych wskaźników KPI i praktyczne strategie redukcji kosztów operacyjnych w przedsiębiorstwach produkcyjnych. Dowiedz się, jak wykorzystać dane z systemu ERP do podejmowania strategicznych decyzji biznesowych.",
    category: "rekord-erp",
