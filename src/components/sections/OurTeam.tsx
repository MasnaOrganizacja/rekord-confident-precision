...
export const OurTeam = () => {
	...
	const team = [
		...
		{
			name: 'Piotr Nowak',
			role: 'Dyrektor Produktu FLOW',
			image: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?q=80&w=400',
			bio: 'Specjalista w zakresie procesów biznesowych i optymalizacji produkcji. Odpowiedzialny za rozwój flagowego produktu NEXORA.FLOW. Certyfikowany audytor ISO 9001.',
		},
		{
			name: 'Magdalena Wiśniewska',
			role: 'Dyrektor Produktu CIVIC',
		...
		<section id="team" className="py-32 bg-white">
			<div className="container mx-auto px-8">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
					{team.map((member, idx) => (
						<div key={idx} onClick={() => setSelectedMember(idx)} className="group cursor-pointer">
				...
				<div
					...
					<div
						...
						<button
							...
							<LineIcon name="close" className="w-6 h-6" />
						</button>
						...
						<p className="text-lg text-gray-700 leading-relaxed">{team[selectedMember].bio}</p>
					</div>
				</div>
			)}
		</section>
