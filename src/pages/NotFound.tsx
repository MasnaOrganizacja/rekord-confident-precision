...
import { Home, ArrowLeft, Search, FileText, Zap, AlertTriangle } from "lucide-react";
...
const NotFound = () => {
  ...
  const quickLinks = [
    ...
    { label: "Rekord.ERP", href: "/rekord-erp", icon: Zap },
    { label: "RATUSZ", href: "/ratusz", icon: FileText },
    { label: "Blog", href: "/blog", icon: Search },
  ];

  return (
    <div ref={containerRef} className="min-h-screen bg-gray-50 flex items-center justify-center overflow-hidden relative">
      {/* Background Pattern */}
      ...
      <div className="max-w-4xl mx-auto px-8 text-center relative z-10">
        ...
        <div className="absolute -top-20 -left-20 floating-icon">
          <AlertTriangle className="w-16 h-16 text-luxury-forest-green/20" />
        </div>
        <div className="absolute -top-10 -right-32 floating-icon">
          <Search className="w-12 h-12 text-luxury-forest-green/20" />
        </div>
        <div className="absolute -bottom-16 -left-32 floating-icon">
          <FileText className="w-14 h-14 text-luxury-forest-green/20" />
        </div>
        ...
        <div className="space-y-12">
          ...
          <div className="relative">
            ...
            >
              404
              {/* Glitch layers */}
              <div className="absolute inset-0 text-red-500 opacity-30 mix-blend-multiply" style={{ transform: 'translate(-2px, 2px)' }}>
                404
              </div>
              <div className="absolute inset-0 text-blue-500 opacity-30 mix-blend-multiply" style={{ transform: 'translate(2px, -2px)' }}>
                404
              </div>
            </div>
          </div>
          ...
          <div className="helpful-links">
            <h3 className="text-2xl font-bold text-gray-900 mb-8 font-rubik">
              Może szukasz czegoś z tego?
            </h3>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
              {quickLinks.map((link, idx) => {
                ...
                return (
                  ...
                  >
                    <IconComponent className="w-8 h-8 text-luxury-forest-green mx-auto mb-3 group-hover:scale-110 transition-transform duration-300" />
