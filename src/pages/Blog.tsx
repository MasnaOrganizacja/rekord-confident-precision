...
import { ArrowRight, Clock, User, Calendar, Filter } from "lucide-react";
...
const Blog = () => {
  ...
  const articles = [
    {
      ...
      excerpt: "Analiza kluczowych wskaźników KPI i praktyczne strategie redukcji kosztów operacyjnych w przedsiębiorstwach produkcyjnych.",
      category: "rekord-erp",
    ...
    },
    {
      ...
      excerpt: "Praktyczne wskazówki dla administratorów publicznych dotyczące budowania skutecznej polityki bezpieczeństwa IT.",
    ...
    {
      id: 7,
      title: "Rekord SI ponownie w gronie Przedsiębiorstw Fair Play",
      excerpt: "Otrzymaliśmy po raz kolejny prestiżowe wyróżnienie za transparentność i wysokie standardy etyczne w biznesie.",
      category: "wydarzenia",
      author: "Zespół Rekord SI",
      date: "2024-01-01",
      readTime: "3 min",
  ...
  const getCategoryColor = (category: string) => {
    const colors: { [key: string]: string } = {
      "rekord-erp": "bg-luxury-forest-green text-white",
      "ratusz": "bg-blue-600 text-white",
  ...
  return (
    <main className="overflow-x-hidden bg-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-8">
                <div className="space-y-6">
                  <div className={`inline-block px-4 py-2 text-sm font-bold ${getCategoryColor(featuredArticle.category)}`}>
      ...
      <section className="py-32 bg-gray-50">
        <div className="container mx-auto px-8">
          <div className="articles-grid columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8">
            {regularArticles.map((article, idx) => (
              <div
                key={article.id}
                className="article-card break-inside-avoid bg-white border-4 border-gray-900 hover:border-luxury-forest-green transition-all duration-300 hover:shadow-2xl group cursor-pointer"
              ...
              >
                ...
                <div className="p-6">
                  <div className={`inline-block px-3 py-1 text-xs font-bold mb-4 ${getCategoryColor(article.category)}`}>
      ...
      <section className="py-32 bg-luxury-forest-green">
        <div className="container mx-auto px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-12 max-w-3xl mx-auto">
            Zapisz się na nasz newsletter i otrzymuj najnowsze artykuły, analizy rynkowe 
            i praktyczne poradniki bezpośrednio na swoją skrzynkę e-mail.
          </p>
          ...
          <div className="max-w-md mx-auto flex gap-4">
            <input
              ...
              className="flex-1 px-6 py-4 border-2 border-white bg-white text-gray-900 text-lg focus:outline-none focus:border-white/80"
            />
            <Button 
              className="bg-white text-luxury-forest-green hover:bg-luxury-forest-green hover:text-white font-bold px-8 py-4 text-lg border-2 border-white transition-all duration-300 hover:scale-105 whitespace-nowrap"
            >
              Zapisz się
            </Button>
          </div>
